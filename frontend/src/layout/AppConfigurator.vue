...
<template>
    ...
    >
        <div class="flex flex-col gap-4">
            ...
            <div>
                <span class="text-sm text-muted-color font-semibold">Superfície</span>
                <div class="pt-2 flex gap-2 flex-wrap justify-between">
                    <button
            ...
            <div class="flex flex-col gap-2">
                <span class="text-sm text-muted-color font-semibold">Predefinições</span>
                <SelectButton v-model="preset" @change="onPresetChange" :options="presetOptions" :allowEmpty="false" />
            </div>
            <div class="flex flex-col gap-2">
                <span class="text-sm text-muted-color font-semibold">Modo de Menu</span>
